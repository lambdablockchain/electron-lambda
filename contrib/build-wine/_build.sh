...
build_the_app() {
    ...
    (
        ...
        cp -r "$here"/../electrum-locale/locale "$WINEPREFIX"/drive_c/electronlambda/electroncash/
        ...
        pushd "$WINEPREFIX"/drive_c/electronlambda
        ...
        # $VERSION could be passed to the electron-lambda.nsi script, but this would require some rewriting in the script iself.
