...
class ScriptOutput(address.ScriptOutput):
    ...
    # due to the way the protocol_match system works in Electron lambda.
...
address.ScriptOutput.protocol_classes.add(ScriptOutput)  # register class with Electron lambda script 'protocol factory' system
